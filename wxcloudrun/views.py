...
def zhfw():
    ...
    :return: 计数的值
    """
    data = [{'title': '浙江省残联等六部门单位关于印发浙江省残疾儿童康复服务制度工作细则（修订版）的通知', 'author_name': '省残联', 'date': '2022-03-11 15:33'},
            {'title': '关于公布残疾人基本型辅助器具目录（第二版）的通知', 'author_name': '省残联', 'date': '2021-12-16 17:04', },
            {
